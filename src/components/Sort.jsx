...
import { setActiveSort, setCurrentPage } from '../redux/slices/filterSlice';
...
export const Sort = ({ sortItems }) => {
  ...
  const clickSortItem = (index) => {
    dispatch(setActiveSort(sortItems[index]));
  ...
  return (
    <div className="sort" ref={rootEl}>
      <div
        ...
        className={`sort__label ${open && 'active'}`}>
        <svg
          width="10"
          height="6"
          viewBox="0 0 10 6"
